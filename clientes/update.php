                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" style="text-transform: uppercase" id="nombre_cliente" class="form-control" value="<?Php echo $nombre_cliente;?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="">Dni/Cif del Cliente <span style="color: red"><b>*</b></span></label>
                                        <input type="text" style="text-transform: uppercase" id="nit_ci_cliente" class="form-control" value="<?php echo $nit_ci_cliente;?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="">Matrícula <span style="color: red"><b>*</b></span></label>
                                        <input type="text" style="text-transform: uppercase" id="placa_auto" class="form-control" value="<?php echo $placa_auto;?>">
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
