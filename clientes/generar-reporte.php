...
$html = '
    ...
    <table border="1" cellpadding="4">
        <tr>
            ...
            <td style="background-color: #c0c0c0;text-align: center" >Dni/Cif del cliente</td>
            <td style="background-color: #c0c0c0;text-align: center" >Matrícula del auto</td>
        </tr>
        ';
        $contador_cliente = 0;
        ...
        foreach($datos_clientes as $datos_cliente){
            ...
            <td style="text-align: center">'.$nit_ci_cliente.'</td>
