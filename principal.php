                                                                        ...
                                                                        <script>
                                                                            $('#btn_registrar_ticket<?php echo $id_map;?>').click(function () { 
                                                                                ...
                                                                                if(placa == ""){
                                                                                    ...
                                                                                    $.get(url_2, {placa:placa, nombre_cliente:nombre_cliente, nit_ci:nit_ci, fecha_ingreso:fecha_ingreso, hora_ingreso:hora_ingreso, espacio:espacio, user_session:user_session}, function(datos) {
                                                                                        $('#respuesta_ticket').html(datos);
                                                                                    });
                                                                                }
                                                                            });
