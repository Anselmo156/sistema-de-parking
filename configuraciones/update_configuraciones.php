                ...
                <div class="col-md-12">
                    <div class="card card-outline card-success">
                        ...
                        <div class="card-body" style="display: block;">
                            <div class="row">
                                <div class="col-md-5">
                                    <label for="">Nombre del Parking <span style="color: red"><b>*</b></span></label>
                                    <input type="text" style="text-transform: uppercase" class="form-control" id="nombre_parqueo" value="<?php echo $nombre_parqueo; ?>">
                                </div>
                                <div class="col-md-5">
                                    <label for="">Actividad de la Empresa <span style="color: red"><b>*</b></span></label>
                                    <input type="text" style="text-transform: uppercase" class="form-control" id="actividad_empresa" value="<?php echo $actividad_empresa; ?>">
                                </div>
                                <div class="col-md-2">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" style="text-transform: uppercase" class="form-control" id="direccion" value="<?php echo $direccion; ?>">
                                </div>
                                <div class="col-md-6">
                                    <label for="">Zona <span style="color: red"><b>*</b></span></label>
                                    <input type="text" style="text-transform: uppercase" class="form-control" id="zona" value="<?php echo $zona; ?>">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" style="text-transform: uppercase" class="form-control" id="departamento_ciudad" value="<?php echo $departamento_ciudad; ?>">
                                </div>
                                <div class="col-md-4">
                                    <label for="">Provincia <span style="color: red"><b>*</b></span></label>
                                    <input type="text" style="text-transform: uppercase" class="form-control" id="pais" value="<?php echo $pais; ?>">
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <button class="btn btn-primary btn-success btn-block" id="btn_actualizar_informacion">
                                        Actualizar
                                    </button>
                                </div>
                            </div>
...
<script>
    $('#btn_actualizar_informacion').click(function () {
        ...
        if(nombre_parqueo == ""){
            alert('Debe de llenar el campo nombre del parking');
            ...
            alert('Debe de llenar el campo provincia');
            $('#pais').focus();
        }else{
