                        ...
                        <div class="card-body" style="display: block;">
                            <div class="row">
                                <div class="col-md-5">
                                    ...
                                    <input type="text" style="text-transform: uppercase" class="form-control" id="nombre_parqueo">
                                </div>
                                <div class="col-md-5">
                                    <label for="">Actividad de la Empresa <span style="color: red"><b>*</b></span></label>
                                    <input type="text" style="text-transform: uppercase" class="form-control" id="actividad_empresa">
                                </div>
                                <div class="col-md-2">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" style="text-transform: uppercase" class="form-control" id="direccion">
                                </div>
                                <div class="col-md-6">
                                    <label for="">Zona <span style="color: red"><b>*</b></span></label>
                                    <input type="text" style="text-transform: uppercase" class="form-control" id="zona">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" style="text-transform: uppercase" class="form-control" id="departamento_ciudad">
                                </div>
                                <div class="col-md-4">
                                    <label for="">Provincia <span style="color: red"><b>*</b></span></label>
                                    <input type="text" style="text-transform: uppercase" class="form-control" id="pais">
                                </div>
                            </div>
                            <hr>
                            <div class="row">
